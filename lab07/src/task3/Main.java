...
public class Main {
    ...
    protected static boolean check(int[] arr, int step) {
    ...
    protected static void printQueens(int[] sol) {
    ...
    public static void main(String[] args) {
        ...
        executorService.submit(new MyRunnable(executorService, count, graph, 0));
        //queens(graph, 0);
    }
}
